...
import cv2
face_cascade=cv2.CascadeClassifier(r"C:\Users\carlo\Documents\olhos-de-ferro-main\olhos-de-ferro-main\projeto_olhosAI\dados2\cascade.xml")###path of cascade file
...
img= cv2.imread(r"C:\Users\carlo\Documents\olhos-de-ferro-main\olhos-de-ferro-main\projeto_olhosAI\dados2\placas_carros\placa-mercosul.png")###path of image file which we want to detect
